...
<div id="product-informations" class="panel product-tab">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="reference">
                    {* Nicolas MAURENT - 10.01.18 - Adding nomenclature link *}
...
{* Nicolas MAURENT - 21.10.17 - Added date to enforce flagging a product as new *}
	<style>
		{literal}
	...
	<div class="form-group">
		 <label class="control-label col-lg-3" for="date-creation">
			 <span class="label-tooltip" data-toggle="tooltip"
					 title="{l s="Added date"}">
					 {$bullet_common_field} {l s="Added date"}
			 </span>
		 </label>
		 <div class="col-lg-3">
