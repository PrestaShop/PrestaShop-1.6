...
<div class="addresses clearfix">
	...
	{if !$opc}
		<div id="ordermsg" class="form-group">
			...
			<!-- Nicolas MAURENT - 05.03.17 - Textarea pre filled-in -->
			<textarea class="form-control" cols="60" rows="6" name="message" placeholder="{l s='Describe your packing preferences here e.g. "i don\'t want bags to be used neither paper nor biodegradable bags" ...'}">{if isset($oldMessage)}{$oldMessage}{/if}</textarea>
		</div>
	{/if}
</div> <!-- end addresses -->
{if !$opc}
