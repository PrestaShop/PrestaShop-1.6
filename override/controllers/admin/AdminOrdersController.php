...
class AdminOrdersController extends AdminOrdersControllerCore
{
    ...
    public function postProcess()
    {
        ...
        elseif (Tools::isSubmit('cancelProduct') && isset($order)) {
            ...
            // Nicolas MAURENT - 31.03.19 - Bug fix: Check on payment module name not needed when in Catalogue mode
    ...
    // Nicolas MAURENT - 01.12.18 - Enable override of orders.js
    ...
    // Nicolas MAURENT - 02.01.21 - Fix not deleted specific price when dying
    public function ajaxProcessAddProductOnOrder()
    {
        ...
        if ($update_quantity < 0) {
            ...
            // Nicolas MAURENT - 02.01.21 - Must delete specific price
